...
import styles from "../assets/styles/projects.scss";
      ...
      <section class="section projects">
        ...
        <div class="project">
          ...
          <div class="project__img">
            <img src="../assets/images/converted_facebook-pro.png" alt="" />
          </div>
          <div class="project__links">
            ...
            <a href="#" target="_blank" class="coolCircleEyeButton">
...
customElements.define("project-component", ProjectsPage);
